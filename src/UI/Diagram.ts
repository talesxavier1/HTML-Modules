        ...
        customShapes: [
            ...
            /* processContainer */
            {
                ...
                toolboxTemplate: (container, data: any) => {
                    ...
                    let icon = $(`
                        <svg x="${(Number((container.position as any)["x"]) * 100).toFixed(0)}" y="${(Number((container.position as any)["y"]) * 10).toFixed(0)}" width="450" height="450" viewBox="0 0 8500 8500" xmlns="http://www.w3.org/2000/svg">
            ...
            /* Multicast In */
            {
                ...
                template: (container, data: any) => {
                    let shapeContainer = $(data);
                    let parentElement = shapeContainer.parent();
                    parentElement.attr("id", "dx_custom_shape_multicast_in");
                    let idRect = Utils.getGuid()
                    $(`
                        <svg viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                            <g transform="matrix(0.1, 0, 0, -0.1, -39.025749, 524.191956)" fill="#000000" stroke="none">
                                <rect id="${idRect}" x="4266.317" y="-4395.41" width="4190.001" height="4149.599" style="fill: none; stroke: #DEDEDE; stroke-width: 150px; stroke-miterlimit: 10.67; transform-box: fill-box; transform-origin: 50% 50%;" transform="matrix(0.707107, -0.707107, -0.707107, -0.707107, -2971.057751, 4562.530347)"></rect>
