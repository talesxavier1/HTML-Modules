...
type TDataSource = SenderModel | ProcessContainerModel | ReciverModel |
    ConditionModel | ExceptionSubprocessModel | EndExceptioModel | ScriptModel |
    DataConverterModel | StartExceptionModel | MultcastOutModel | MultcastInModel |
    StartProcessModel | EndProcessModel;
class NodeStore {
