...

{
                ...
                defaultText: "Processo",
                template: (container, data) => {
                    let shapeContainer: SVGSVGElement = data[0];
                    shapeContainer.id = "teste0011";

                    let parentElement = shapeContainer.parentElement;
                    let childrenParent = parentElement.children;
                    let coun = 0;
                    // for (let a of childrenParent) {
                    //     a.id = coun.toString();
